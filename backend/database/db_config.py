...
def set_up_db(app):
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://snusocaftkkyuo:11e86473808e19f2815f3eba794570eb71b8cc856cb2bcd356cf5b02b7617cb2@ec2-107-20-15-85.compute-1.amazonaws.com:5432/dbj0q5d11nhbva'
    db.app = app
    db.init_app(app)
